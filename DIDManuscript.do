*=============================================================================*
* Project title: DID Manuscript
* Created by: Yuzheng Wang (econyzhwang@gmail.com)
...
*Draw a panel data diagram
panelview asmrs post,i(state_alph) t(year) type(treat) mycolor(lean) xtitle("Year") ytitle("State") graphregion(color(white))

*Bsaline estimates
reghdfe asmrs post pcinc asmrh cases, absorb(year stfips) 
...
*1. Outcome (FEs play no role since all methods control for them)
gen Y = i + 3*t + tau*D + eps
		
*2. did_imputation of Borusyak et al. (2021)
...
*3. did_multiplegt of de Chaisemartin and D'Haultfoeuille (2020)
...
*4. csdid of Callaway and Sant'Anna (2020) (v1.5 written by Fernando Rios-Avila @friosavila)
...
*5. eventstudyinteract of Sun and Abraham (2020)
sum Ei
...
*7. stackedev of Cengiz et al. (2019) 
...
graph export "comparison_estimators.png", replace
